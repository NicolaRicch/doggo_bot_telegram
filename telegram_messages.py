...
Modifica questi messaggi per personalizzare l'interfaccia del bot!
...
class TelegramMessages:
    ...
    WELCOME_USER = """🐾Ciao! Io sono DoggoBot, il tuo assistente AI dedicato al mondo dei cani!  

Posso aiutarti a:
🐶 Scoprire informazioni su razze, cura, addestramento ed educazione
📚 Rispondere alle domande sui documenti caricati dagli admin
🔍 Cercare informazioni affidabili sul web
🖼️ Analizzare foto del tuo cane (comportamento, razza, curiosità)
💬 Mantenere una conversazione naturale e continua

⚠️ Non sono un veterinario: per problemi di salute seri, rivolgiti sempre a un professionista.
...
Scrivimi pure, sono qui per aiutarti! 🐕✨"""

    WELCOME_ADMIN = """🐾Ciao Admin! Sono DoggoBot, assistente AI dedicato all’universo dei cani.  

🔧 COMANDI ADMIN:
/add_doc - Carica documenti informativi (PDF, DOCX, TXT, MD)
/list_docs - Lista documenti caricati
/get_doc - Scarica documento originale tramite ID
/modify_summary - Modifica il sommario RAG
/delete_doc - Rimuovi un documento tramite ID
/stats - Statistiche sistema e RAG
/memory_stats - Stato memoria e storage
...
Sono pronto a supportarti nella gestione dei contenuti del bot! 🐶📂"""
    ...
    HELP_MESSAGE_USER = """📖 GUIDA DOGGOBOT
...
• Le immagini vanno inviate come "documento" per qualità migliore"""
    ...
    HELP_MESSAGE_ADMIN = """📖 GUIDA DOGGOBOT (ADMIN)
